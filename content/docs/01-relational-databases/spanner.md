...
description: "Spanner is Google's globally distributed, strongly-consistent, horizontally scalable SQL database. It famously claims \"externally consistent transactions across continents\" thanks to TrueTime (atomic clocks + GPS in e..."
---
