---
title: "Apache Hadoop"
description: "Hadoop is the OG big-data ecosystem: a distributed file system (HDFS), a job scheduler (YARN), and a batch programming model (MapReduce). It made it cheap to store and crunch petabytes on commodity hardware. While mod..."
---
